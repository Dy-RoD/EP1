...
// Funcion la Cual Validara los Campos del Inicio de Sesion Para Ver Si Cumplen Con el Formato Requerido
document.getElementById('formLogin').addEventListener('submit', function(event) {
    // Variables Para Tener el Input email y contraseña
    const email = document.getElementById('email').value;
    const password = document.getElementById('password').value;

    // Se Comprueba si Los Inputs No Estan Vacios
    if (email === '' || password === '') {
